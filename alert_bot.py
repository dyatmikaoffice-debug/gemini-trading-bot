        ...
        try:
            ...
            if "values" in data:
                ...
                if last_trade and last_trade['outcome'] in ['WIN (TP1 HIT)', 'WIN (TP2 HIT)', 'CLOSED (TP1 HIT / SL BE)']:
                    min_distance = 3.0  # Reduced Cooldown for Risk-Free Continuation
                ...
                if proposed_action != "HOLD":
                    ...
                    sl_dist = max(4.5, min(8.0, atr * 2.0))  # Structural ATR Buffer
